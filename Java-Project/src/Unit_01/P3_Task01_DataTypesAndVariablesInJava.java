...
/*
 - Variable in Java is a data container that saves the data values during the Java program execution
...
public class P3_Task01_DataTypesAndVariablesInJava {
	...
	public static void main(String[] args) {
		...
		byte k = 10; // 1 byte
		boolean l = true; // 1 byte = true or false only
		long m = 10L;
		float n = 1.2f;
		double o = 1.2d;
...
class ABC {
	...
	static void typeConversionAndTypeCasting() {
		...
		/*
		 * double f; // B bytes 64 bits/slots int i = 10; // 4 bytes = 32 bits/slots 
		 * f = i; // Type Conversion 
		 * System.out.println(f);
		 * 
		 * double g = 10; // 64 
